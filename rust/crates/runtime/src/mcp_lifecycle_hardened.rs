...
impl McpLifecycleValidator {
    ...
    pub fn validate_phase_transition(from: McpLifecyclePhase, to: McpLifecyclePhase) -> bool {
        match (from, to) {
            (McpLifecyclePhase::ConfigLoad | McpLifecyclePhase::ServerRegistration, McpLifecyclePhase::ServerRegistration)
            | (McpLifecyclePhase::ServerRegistration | McpLifecyclePhase::SpawnConnect, McpLifecyclePhase::SpawnConnect)
            | (McpLifecyclePhase::SpawnConnect | McpLifecyclePhase::InitializeHandshake, McpLifecyclePhase::InitializeHandshake)
            | (McpLifecyclePhase::InitializeHandshake | McpLifecyclePhase::ToolDiscovery, McpLifecyclePhase::ToolDiscovery)
            ...
            (_, McpLifecyclePhase::ErrorSurfacing) => {
                !matches!(from, McpLifecyclePhase::Cleanup | McpLifecyclePhase::Shutdown)
            }
            _ => false,
        }
    }
